...
class Formation extends WpAlgoliaRegisterAbstract implements WpAlgoliaRegisterInterface
{
    public $searchable_fields = array('post_title');

    public $acf_fields = array('introduction', 'description', 'trainer_bio');

    public $taxonomies = array('formation_type');
